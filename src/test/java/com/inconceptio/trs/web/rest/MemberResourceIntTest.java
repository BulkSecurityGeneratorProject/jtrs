...
import com.inconceptio.trs.repository.MemberRepository;
import com.inconceptio.trs.repository.search.MemberSearchRepository;
...
public class MemberResourceIntTest {
    ...
    public void setup() {
        MockitoAnnotations.initMocks(this);
            MemberResource memberResource = new MemberResource(memberRepository, memberSearchRepository);
